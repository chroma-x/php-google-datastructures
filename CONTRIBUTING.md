# Contributing to PHP Google Data Structures
...
Here’s an example workflow for `php-google-datastructures` hosted on Github, which is currently in version 1.0.2. Your username is `yourname` and you’re submitting a basic bugfix. 

### Preparing your Fork

- Hit ‘fork’ on Github, creating e.g. `yourname/php-google-datastructures`
- Clone your project  

```
git clone git@github.com:yourname/php-google-datastructures
```

- Create a branch

```
cd php-google-datastructures
